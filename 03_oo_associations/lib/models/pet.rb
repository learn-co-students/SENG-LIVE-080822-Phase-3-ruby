class Pet 
    ...
    # A pet has many handlers through appointments
    # Appointment belongs to one pet
    # pet -< Appointment >- handler
    def handlers
      self.appointments.map{|a| Handler.all.find{|h| h.id == a.handler_id}}
    end 
